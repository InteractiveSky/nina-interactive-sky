...
namespace NINA.InteractiveSky.InteractiveSkyTestCategory {
    ...
    public class InteractiveSkyCondition : SequenceCondition {
        /// <summary>
        ...
        public InteractiveSkyCondition() {
            IsTruthy = true;
        }
        ...
        public override object Clone() {
            return new InteractiveSkyCondition() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(InteractiveSkyCondition)}, IsTruthy: {IsTruthy}";
        }
    }
}