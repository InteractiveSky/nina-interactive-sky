...
namespace NINA.InteractiveSky.InteractiveSkyTestCategory {
    /// <summary>
    ...
    [ExportMetadata("Category", "Interactive Sky")]
    [Export(typeof(ISequenceItem))]
    [JsonObject(MemberSerialization.OptIn)]
    public class InteractiveSkyInstruction : SequenceItem {
        /// <summary>
        ...
        public InteractiveSkyInstruction() {
            Text = Settings.Default.DefaultNotificationMessage;
        }
        public InteractiveSkyInstruction(InteractiveSkyInstruction copyMe) : this() {
            CopyMetaData(copyMe);
        }
        ...
        public override object Clone() {
            return new InteractiveSkyInstruction(this);
        }
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(InteractiveSkyInstruction)}, Text: {Text}";
        }
    }
}