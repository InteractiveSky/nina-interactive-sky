...
namespace NINA.InteractiveSky.InteractiveSkyTestCategory {
    ...
    public class InteractiveSkyTrigger : SequenceTrigger {
        /// <summary>
        ...
        public InteractiveSkyTrigger() {
        }

        public override object Clone() {
            return new InteractiveSkyTrigger() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(InteractiveSkyTrigger)}";
        }
    }
}