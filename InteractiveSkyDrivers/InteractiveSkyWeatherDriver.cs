...
namespace NINA.InteractiveSky.InteractiveSkyDrivers {
    ...
    /// </summary>
    public class InteractiveSkyWeatherDriver : BaseINPC, IWeatherData {
        public InteractiveSkyWeatherDriver(string uniqueId, string deviceId) {
            Id = uniqueId;
            serialNumber = deviceId;
            Name = $"InteractiveSky Weather Data ({deviceId})";
        ...
        public string Category => "InteractiveSky Weather Driver";
