...
namespace NINA.InteractiveSky.InteractiveSkyDrivers {
    /// <summary>
    ...
    public class InteractiveSkyWeatherProvider : IEquipmentProvider<IWeatherData> {
        private IProfileService profileService;

        [ImportingConstructor]
        public InteractiveSkyWeatherProvider(IProfileService profileService) {
            this.profileService = profileService;
        }

        public string Name => "InteractiveSky";

        public IList<IWeatherData> GetEquipment() {
            var devices = new List<IWeatherData>();
            devices.Add(new InteractiveSkyWeatherDriver("MyUniqueId", "MyDeviceId"));
